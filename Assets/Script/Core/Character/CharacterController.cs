...
public class CharacterController : MonoBehaviour
{
    ...
    //    addEventListener("Events/MoveLeftEvent", OnMoveLeft);
    //    addEventListener("Events/MoveRightEvent", OnMoveRight);
    //    addEventListener("Events/MoveLeftEvent", OnMoveLeft);
    //}

    //private void OnMoveRight(Component arg0, object arg1)
    //{
    //    Debug.Log("Move Right: " + arg1.ToString());
    //    //gameObject.GetComponent<Rigidbody2D>().velocity = Vector2.right * 10f;
    //}

    //private void OnMoveLeft(Component sender, object data)
    //{
    //    Debug.Log("Move Left: " + data.ToString());

    //    gameObject.GetComponent<Rigidbody2D>().velocity = Vector2.left * 10f;
