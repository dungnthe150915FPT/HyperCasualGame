...
public class WizardEneController : MonoBehaviour
{
    ...
    //        wizardEnemy.CurrentHealth -= 10;
    //        if (wizardEnemy.CurrentHealth <= 0)
    //        {
    //            // set inactive wizard
    ...
    //// an unity event to attack player
    //public void shouldAttackPlayer(Component sender, object data)
    //{
    //    Collider2D collision = (Collider2D)data;
    ...
    //public void playerOutOfSight(Component sender, object data)
    //{
    //    isAttacking = false;
    //}

    //public void playerStayInSight(Component sender, object data)
    //{
    //    isAttacking = true;
    //}
    ...
    //private bool isBullet(Collider2D collision)
    //{
    ...
    //    BaseToxin baseMagic = new BaseToxin();
    //    baseMagic.Damage = 5f;
    //    baseMagic.Speed = 80f;
